...
!
 ...
 CHARACTER(len=14)         ::   FNAMEIND,FNAME1,FNAME2
		 
 INTEGER(KIND=JPIM)                 ::   IREP,INMAX,INUM1,INUM2,INUM3
 ...
 namelist/namblend/FNAMEIND,FNAME1,FNAME2,CL_CGRID,I_NGRID,REP_TYPE
...
WRITE(*,*) 'Opening indterremer file ',FNAMEIND
 inmax=1
 CALL faitou(IREP,INUM3,.true.,FNAMEIND,'OLD',.true.,&
&.false.,0,inmax,inmax,'CADRE LECTURE2  ')
CALL FACILE(IREP,INUM3,'SURF',1,'IND.TERREMER',ZLSM,.FALSE.)
